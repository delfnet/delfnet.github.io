var Looper = function (controller, timer, params) {
...
Looper.prototype.start = function () {
  ...
  //console.log( this.timer.time.value );
  //console.log( this.timer.dT.value );
  this.ogStart = this.timer.time.value + this.timer.dT.value;
...
Looper.prototype.updateTime = function () {
  ...
  // console.log(this.timeInMeasure);
  this.oPercentOfMeasure = this.percentOfMeasure;

  this.timeInMeasure = this.timer.time.value - this.measureStartTime;
  this.percentOfMeasure = this.timeInMeasure / this.measureLength;


  this.timeInLoop = this.timer.time.value - this.loopStartTime;
